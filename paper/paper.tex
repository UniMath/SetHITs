...
\newcommand{\SZ}{\constructor{S}} % zero
...
\begin{abstract} 
  ...
  The desired algebra is obtained by lifting the quotient adjunction to the level of algebras and adapting Dybjer's and Moenclaey's interpretation of HITs in setoids.
...
HITs have also been studied more formally and several schemes have already been developed.
...
Then for each $x, y : ...$ we have an equivalence $....$.
\end{corollary}

\section{Conclusion and Further Work}
\label{sec:conclusion}
\cite{ahrens2019bicategories}
\cite{capriotti2017univalent}
